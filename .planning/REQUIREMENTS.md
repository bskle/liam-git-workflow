...
- [ ] **DIAG-05**: 更新 `skills/liam-git-workflow/SKILL.md` — 添加路由规则：远程失败描述 → 诊断能力、执行中远程操作失败 → 诊断能力
- [ ] **DIAG-06**: 更新 `references/scenarios.md` — 补充远程故障场景示例（push/pull/fetch/ls-remote 各至少一个）
- [ ] **DIAG-07**: 更新 sync 相关命令文档 — 在同步操作文档中引用远程诊断能力
